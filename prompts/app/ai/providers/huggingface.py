...
def generate(prompt,instructions,model=None,max_tokens=6000):
 ...
 r=OpenAI(api_key=key,base_url="https://router.huggingface.co/v1").chat.completions.create(model=model,messages=[{"role":"system","content":instructions},{"role":"user","content":prompt}],max_tokens=max_tokens,temperature=.65)
