...
function applyVisual(v=activeVisual()){const root=document.documentElement;if(v.theme==="system")v={...v,theme:"dark"};if(v.layout==="compacto"||v.layout==="modernox"||v.layout==="moderno")v={...v,layout:"clean"};const accent=v.layout==="clean"?"#08c6c9":"#d6b25e";root.dataset.layout=v.layout;root.dataset.theme="dark";root.dataset.mobileLayout=v.mobileLayout||"mobile-pro";root.style.setProperty("--accent",accent);root.style.setProperty("--gold",accent);syncManifestIcon();updateNavIcons(v.layout);}
const NAV_META={
