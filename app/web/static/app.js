...
const views={
 dashboard(){const s=projectStats(),h=Store.get("history",[])[0];return `<div class="hero"><h1>LOGOS MASTER X 3.7.1</h1><p>Preparação bíblica • IA multiprovedor • DNA K7 • uso local + nuvem</p></div>
<div class="grid">
