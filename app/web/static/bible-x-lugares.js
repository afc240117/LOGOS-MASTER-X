...
(function () {
  ...
  var LUGARES = [
    ...
    ["⚔️", "Monte Gilboa", 32.53, 35.42, 32.529649, 35.420721,
     "Monte Gilboa; gilboa; mount gilboa"],
    ["🌋", "Monte Seir", 30.25, 35.4, 30.253246, 35.395964,
     "Monte Seir; seir; mount seir; monte de seir"],
    ["🕯️", "Monte Hor", 30.317, 35.407, 30.314922, 35.398972,
     "Monte Hor; hor; mount hor"],
    ["🌵", "Deserto de Zim", 30.95, 34.9, 30.950107, 34.899183,
     "Deserto de Zim; zim; zin; deserto de zin"],
    ["🌾", "Sarom", 32.4, 34.9, 32.400258, 34.899555,
     "Sarom; sarom; sharon; planicie de sharon"],
    ["🐪", "Neguebe", 30.8, 34.8, 30.793839, 34.79667,
     "Neguebe; neguebe; negev; negeb"],
    ["🏺", "Libna", 31.6282, 34.8625, 31.627595, 34.862356,
     "Libna; libna; libnah"],
    ["🕳", "Maressa", 31.5933, 34.895, 31.594725, 34.895728,
     "Maressa; maressa; mareshah"],
    ["🧱", "Queila", 31.6172, 34.9978, 31.617464, 34.997829,
     "Queila; queila; keilah"],
    ["🏘", "Socó", 31.683, 34.966, 31.683004, 34.966001,
     "Socó; socoh"],
    ["🛡", "Azeca", 31.6997, 34.9358, 31.699678, 34.935729,
     "Azeca; azeca; azekah"],
    ["🍯", "Estaol", 31.7739, 34.9858, 31.773835, 34.985879,
     "Estaol; estaol; eshtaol"],
    ["🏯", "Jarmute", 31.7097, 34.9711, 31.709, 34.970387,
     "Jarmute; jarmute; jarmuth"],
    ["🕍", "Estemoa", 31.3997, 35.0667, 31.399701, 35.066619,
     "Estemoa; estemoa; eshtemoa"],
    ["📜", "Debir", 31.3858, 34.9164, 31.386583, 34.914781,
     "Debir; debir; quiriate-sefer"],
    ["🐑", "Arade", 31.2806, 35.125, 31.281694, 35.124918,
     "Arade; arade; arad"],
    ["🏗", "Bete-Zur", 31.5828, 35.0983, 31.582041, 35.09999,
     "Bete-Zur; bete-zur; beth-zur"],
    ["🐐", "Zife", 31.4722, 35.1389, 31.471282, 35.138121,
     "Zife; zife; ziph"],
    ["⛺", "Maom", 31.4139, 35.14, 31.410755, 35.140971,
     "Maom; maom; maon"],
    ["🐂", "Tecoa", 31.6367, 35.2108, 31.636765, 35.210309,
    ...
    ["🌙", "Aijalom", 31.84, 34.99, 31.840039, 34.98998,
     "Aijalom; aijalom; aijalon; ayalon"],
    ["📯", "Anatote", 31.8097, 35.26, 31.809644, 35.260742,
     "Anatote; anatote; anathoth"],
    ["⚒️", "Micmás", 31.87, 35.28, 31.87062, 35.279188,
     "Micmás; micmas; michmash; michmas"],
    ["🗡", "Geba", 31.8572, 35.2597, 31.856331, 35.258612,
     "Geba; geba; gaba"],
    ["🌿", "Ofra", 31.9544, 35.3006, 31.954313, 35.300396,
     "Ofra; ofra; ophrah"],
    ["🌀", "Gilgal", 31.865, 35.445, 31.866558, 35.443489,
     "Gilgal; gilgal"],
    ["👑", "Tirsá", 32.2886, 35.3014, 32.290516, 35.303433,
     "Tirsá; tirsa; tirzah"],
    ["🌺", "En-Ganim", 32.46, 35.3, 32.459936, 35.300182,
     "En-Ganim; en-ganim; en gannim; jenin"],
    ["🪓", "Ibleão", 32.4997, 35.2344, 32.500413, 35.233415,
     "Ibleão; ibleao; ibleam"],
    ["⚖️", "Piratom", 32.1833, 35.0833, 32.18325, 35.084002,
     "Piratom; piratom; pirathon"],
    ["🗼", "Quedes", 33.1122, 35.5297, 33.112054, 35.529981,
     "Quedes; quedes; kedesh"],
    ["🌊", "Abel-Bete-Maaca", 33.2542, 35.5789, 33.253789, 35.581921,
     "Abel-Bete-Maaca; abel-bete-maaca; abel beth maacah"],
    ["🐟", "Gite-Héfer", 32.74, 35.32, 32.73866, 35.320183,
    ...
    ["🐍", "En-Dor", 32.6383, 35.39, 32.63772, 35.389684,
     "En-Dor; en-dor; endor"],
    ...
    ["🌉", "Aroer", 31.4739, 35.7667, 31.470134, 35.771395,
     "Aroer; aroer; aroer de moabe"],
    ["🪦", "Dibom", 31.498, 35.783, 31.498077, 35.783025,
     "Dibom; dibom; dibon"],
    ["🛣️", "Medeba", 31.716, 35.794, 31.715935, 35.791917,
    ...
    ["🌴", "Zered", 31, 35.65, 30.99819, 35.652935,
    ...
    ["🛶", "Eziom-Geber", 29.5444, 34.9803, 29.543917, 34.981832,
    ...
    ["⚰️", "Aceldama", 31.7692, 35.2308, 31.769369, 35.230715,
     "Aceldama; aceldama; akeldama; campo de sangue"],
    ["🪣", "Poço de Jacó", 32.2094, 35.2836, 32.209407, 35.283624,
     "Poço de Jacó; poco de jaco; jacobs well"],
    ["🫗", "Sicar", 32.2064, 35.2764, 32.21089, 35.278898,
     "Sicar; sicar; sychar"],
    ["🕊️", "Naim", 32.6317, 35.3486, 32.633887, 35.347752,
     "Naim; naim; nain"],
    ["🍞", "Genezaré", 32.8472, 35.5222, 32.847406, 35.521967,
     "Genezaré; gene sare; genesaré; gennesaret"],
    ["🐖", "Gadara", 32.6553, 35.6836, 32.655333, 35.684162,
     "Gadara; gadara; umm qais"],
    ["🎭", "Gerasa", 32.2803, 35.8914, 32.280017, 35.89212,
     "Gerasa; gerasa; jerash"],
    ["🔟", "Decápolis", 32.4, 35.8, 32.401529, 35.799418,
    ...
    ["🏛️", "Perge", 36.9603, 30.8542, 36.959812, 30.85352,
     "Perge; perge; perga"],
    ["🛥️", "Patara", 36.2603, 29.3175, 36.260524, 29.316612,
     "Patara; patara"],
    ...
    ["🍇", "Samos", 37.7, 26.95, 37.699965, 26.949907,
     "Samos; samos"],
    ...
    ["🐪", "Arábia", 30.5, 36.5, null, null,
     "Arábia; arabia"],
    ["🏙", "Bete-Seã", 32.5044, 35.502, 32.504123, 35.500867,
     "Bete-Seã; bete-sea; beth-shan; beth-shean; betsa"],
    ["⚔️", "Ziclague", 31.3925, 34.6808, 31.392779, 34.680654,
     "Ziclague; ziclague; ziklag"],
    ["🏺", "Eglom", 31.5483, 34.9153, 31.547461, 34.916524,
     "Eglom; eglom; eglon"],
    ["⛰", "Jocmeão", 32.6583, 35.0989, 32.658294, 35.098882,
     "Jocmeão; jocmeao; jokneam"],
    ["🛡", "Taanaque", 32.5186, 35.2164, 32.518669, 35.216488,
     "Taanaque; taanaque; taanach; tanac"],
    ["💪", "Hormá", 31.1944, 34.95, 31.194422, 34.95063,
     "Hormá; horma; hormah"],
    ["🏔", "Carmelo de Judá", 31.4214, 35.13, 31.425336, 35.132826,
     "Carmelo de Judá; carmelo de juda; quirbet el carmil"],
    ["🏛", "Adoraím", 31.5089, 35.0267, 31.508844, 35.026639,
     "Adoraím; adoraim; adoraim de juda"],
    ["🚩", "Maanaim", 32.19, 35.655, 32.190114, 35.655001,
    ...
    ["🏜", "Aravá", 30.5, 35.2, 30.501244, 35.199725,
     "Aravá; arava; arabah; planicie do jordao"],
    ["🌊", "Rio Querite", 31.84, 35.42, 31.836127, 35.419389,
     "Rio Querite; querite; cherith; ribeiro de querite"],
    ["🏛", "Migdol", 30.97, 32.42, 30.970373, 32.422083,
     "Migdol; migdol"],
    ["🏛", "Pelúsio", 31.04, 32.54, 31.041548, 32.542132,
     "Pelúsio; pelusio; pelusium; tell el-farama"],
    ["🏛", "Cirene", 32.82, 21.858, 32.820185, 21.858201,
     "Cirene; cirene; cyrene; cireneu"],
    ["🏛", "Gortina", 35.0631, 24.9469, 35.063176, 24.94631,
