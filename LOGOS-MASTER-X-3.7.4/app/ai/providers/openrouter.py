...
def generate(prompt,instructions,model=None,max_tokens=12000):
 ...
 r=OpenAI(api_key=key,base_url="https://openrouter.ai/api/v1").chat.completions.create(model=model,messages=[{"role":"system","content":instructions},{"role":"user","content":prompt}],max_tokens=max_tokens,temperature=.65)
